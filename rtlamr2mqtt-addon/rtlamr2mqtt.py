...
if __name__ == "__main__":
    ...
    rtl433_cmd = ['/usr/bin/rtl_433', '-d', 'rtl_tcp://192.168.2.98:1235', '-R', '0', '-R', '40', '-F', 'mqtt://' + config['mqtt']['host'] + ':' + str(config['mqtt']['port']) + ',user=' + config['mqtt']['user'] + ',pass=' + config['mqtt']['password'] + ',devices=rtl_433[/model][/id],retain=1']
